...
class OpenAIUsrMsgClient:
    ...
    async def usr_msg_proposal(self):
        try:
            ...
            prompt = f"""
            [System]
            You are a professional in business plan writing. You are provided with an user input in form of sentence or paragraph. Your task is to provide a paragraph between 300-700 characters for assisting write business plan.

            #### Instructions ####

            Step 1. Read the user input. The basic language is Korean. But if provided in other language, use it. Fix any typos. 
            ...
            Step 4. Format the output as valid string.
            Step 5. please write about 1000 to 1500 characters so that the content is rich and conveys the content.
            Step 6. Don't need to repeat content for fitting the output characters. Use the other words and expressions.
            ...
            Output : "Write business plan, narratively"
            [/System]
