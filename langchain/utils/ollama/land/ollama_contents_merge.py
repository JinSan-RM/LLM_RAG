...
class OllamaDataMergeClient:
    ...
    async def contents_merge(self) -> str:
        ...
        만약 모자란 정보가 있다면 PDF 요약 데이터를 함께 고려하면서 너가 적당한 창의성을 발휘해서 작성해줘.
            ...
            2) 브랜드명 : 회사나 제품의 이름
            3) 슬로건 혹은 캐치 프레이즈 : 기업의 주요 비전이나 이념을 한 문장으로 표현
            4) 타겟 고객 : 주요 고객층의 특성과 니즈
            5) 핵심 가치 제안 : 고객에게 제공하는 독특한 가치
            6) 제품 및 서비스 특징 : 주요 기능과 장점
            7) 비즈니스 모델 : 잠재 고객에게 제품이나 서비스에 차별화된 가치를 담아 제공함으로써 수익을 창출하는 일련의 프로세스
            8) 홍보 및 마케팅 전략 : 제품이나 서비스를 고객에게 소개하는 방법
